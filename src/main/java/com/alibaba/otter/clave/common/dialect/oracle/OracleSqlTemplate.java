package com.alibaba.otter.clave.common.dialect.oracle;

import com.alibaba.otter.clave.common.dialect.AbstractSqlTemplate;
...
public class OracleSqlTemplate extends AbstractSqlTemplate {
    ...
    public String getMergeSql(String schemaName, String tableName, String[] keyNames, String[] columnNames,
        ...
        sql.append("merge /*+ use_nl(a b)*/ into ").append(getFullName(schemaName, tableName)).append(" ").append(
                                                                                                                  aliasA);
