package com.alibaba.otter.clave.utils;
 ...
 */
public class ClaveToStringStyle extends ToStringStyle {
     ...
     * </pre>
     */
    public static final ToStringStyle TIME_STYLE       = new ClaveDateStyle(DEFAULT_TIME);
     ...
     * </pre>
     */
    public static final ToStringStyle DAY_STYLE        = new ClaveDateStyle(DEFAULT_DAY);
     ...
     * </pre>
     */
    public static final ToStringStyle DEFAULT_STYLE    = ClaveToStringStyle.TIME_STYLE;
     ...
     * @author li.jinl
     */
    private static class ClaveDateStyle extends ToStringStyle {
        ...
        public ClaveDateStyle(String pattern){
            super();
